...
<?php } ?>
<input type="hidden" id="calisia-cutomer-note-nonce"   name="calisia-cutomer-note-nonce"   value="<?php echo $args['nonce']; ?>">
<input type="hidden" id="calisia-cutomer-note-user-id" name="calisia-cutomer-note-user-id" value="<?php echo $args['user_id']; ?>">
</div>